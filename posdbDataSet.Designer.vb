...
Partial Public Class posdbDataSet
    ...
    Partial Public Class productDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddproductRow(ByVal SKU As String, ByVal prod_name As String, ByVal price As Double) As productRow
            Dim rowproductRow As productRow = CType(Me.NewRow,productRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, SKU, prod_name, price}
    ...
    Partial Public Class productRow
        ...
        Public Function IsSKUNull() As Boolean
            Return Me.IsNull(Me.tableproduct.SKUColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetSKUNull()
            Me(Me.tableproduct.SKUColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace posdbDataSetTableAdapters
    ...
    Partial Public Class productTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `product` WHERE ((`ID` = ?) AND ((? = 1 AND `SKU` IS NULL) OR (`SKU` "& _ 
                "= ?)) AND ((? = 1 AND `prod_name` IS NULL) OR (`prod_name` = ?)) AND ((? = 1 AND"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `product` (`SKU`, `prod_name`, `price`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `product` SET `SKU` = ?, `prod_name` = ?, `price` = ? WHERE ((`ID` = ?) AN"& _ 
                "D ((? = 1 AND `SKU` IS NULL) OR (`SKU` = ?)) AND ((? = 1 AND `prod_name` IS NULL"& _ 
                ") OR (`prod_name` = ?)) AND ((? = 1 AND `price` IS NULL) OR (`price` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.POS.My.MySettings.Default.posdbConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, SKU, prod_name, price FROM product"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As posdbDataSet.productDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As posdbDataSet.productDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As posdbDataSet.productDataTable = New posdbDataSet.productDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As posdbDataSet.productDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_SKU As String, ByVal Original_prod_name As String, ByVal Original_price As Global.System.Nullable(Of Double)) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_prod_name,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal SKU As String, ByVal prod_name As String, ByVal price As Global.System.Nullable(Of Double)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal SKU As String, ByVal prod_name As String, ByVal price As Global.System.Nullable(Of Double), ByVal Original_ID As Integer, ByVal Original_SKU As String, ByVal Original_prod_name As String, ByVal Original_price As Global.System.Nullable(Of Double)) As Integer
            If (SKU Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_SKU,String)
            End If
            If (Original_prod_name Is Nothing) Then
